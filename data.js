...
export const mainDishes = [
  ...
  ["担々麺", "images/ramen_tantanmen.png", "辛さの中に旨みが凝縮！カラダをポカポカ暖めよう！今夜は担々麺を食べ尽くそう！"],
  ["鶏の山賊焼", "images/food_sanzokuyaki_age.png", "一口食べたら、止まらない！特製だれに漬け込み、パリッと焼き上げた山賊焼をどうぞ召し上がれ。"],
  ["ペペロンチーノ", "images/food_spaghetti_pepperoncino.png", "材料は至ってシンプル。完成されたレシピに余計なものはいらない。そんな今夜はペペロンチーノ。"],
  ["鮭のムニエル", "images/food_moritsuke_good.png", "バターが香るカリッと焼けた鮭。ひと口ごとに、ふんわり幸せが広がる今夜の食卓。"],
...
export const sideDishes = [
  ...
  ["きんぴらごぼう", "images/food_kinpira_gobou.png"],
  ["だし巻き卵", "images/food_tamagoyaki.png"],
  ["ポテトサラダ", "images/food_potato_sald.png"],
  ["キュウリの浅漬け", "images/food_tsukemono_kyuuri.png"],
  ["コールスロー", "images/vegetable_coleslaw_salad.png"],
  ["キムチ", "images/food_kimuchi.png"],
  ["おひたし", "images/food_hourensou_ohitashi.png"],
  ["煮物", "images/food_yasai_nimono.png"],
];
